...
{{/*
SnapshotLease controller service account name.
*/}}
{{- define "sg-cosi-driver.snapshotLeaseServiceAccountName" -}}
{{- if .Values.snapshotLease.serviceAccount.create }}
{{- default (printf "%s-snapshotlease" (include "sg-cosi-driver.fullname" .)) .Values.snapshotLease.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.snapshotLease.serviceAccount.name }}
{{- end }}
{{- end }}
