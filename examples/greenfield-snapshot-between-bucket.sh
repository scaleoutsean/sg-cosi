...
parameters:
  ...
  filterType: "between"
  afterTime: "2026-06-23T07:59:00.000Z" # Lower limit timestamp; DISABLE_FUTURE_DATETIME (default: true) prevents future timestamps from being used, so this is a safe lower limit
  beforeTime: "2026-07-23T07:59:00.000Z" # Upper limit timestamp; DISABLE_FUTURE_DATETIME (default: true) prevents future timestamps from being used, so this is a safe lower limit
EOF
